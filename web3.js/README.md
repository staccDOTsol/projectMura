...
[npm-image]: https://img.shields.io/npm/v/../../web3.js.svg?style=flat
[npm-downloads-image]: https://img.shields.io/npm/dm/../../web3.js.svg?style=flat
[npm-url]: https://www.npmjs.com/package/../../web3.js
...
<script src="https://unpkg.com/../../web3.js@latest/lib/index.iife.js"></script>

<!-- Production (minified) -->
<script src="https://unpkg.com/../../web3.js@latest/lib/index.iife.min.js"></script>
```
...
```js
const solanaWeb3 = require('../../web3.js/src');
...
```js
import * as solanaWeb3 from '../../web3.js/src';
console.log(solanaWeb3);
```
...
https://unpkg.com/../../web3.js@v1.37.2/module.flow.js.
Download the file and add the following line under the [libs] section of your project's `.flowconfig` to
activate it:

```ini
[libs]
node_modules/../../web3.js/module.flow.js
```

## Releases

Releases are available on [Github](https://github.com/solana-labs/solana-web3.js/releases)
and [npmjs.com](https://www.npmjs.com/package/../../web3.js)
